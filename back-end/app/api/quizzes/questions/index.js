...
router.post('/', (req, res) => {
  try {
    ...
    let question = Question.create({ label: req.body.label, explanation: req.body.explanation, quizId })
...
router.put('/:questionId', (req, res) => {
  try {
    const question = getQuestionFromQuiz(req.params.quizId, req.params.questionId)
    const updatedQuestion = Question.update(req.params.questionId, { label: req.body.label, explanation: req.body.explanation, quizId: question.quizId })
